	...
	return (
		<ToggleGroupPrimitive
			...
			className={cn(
				...
				"data-[variant=tabs]:bg-base-3 data-[variant=tabs]:p-[3px] data-[variant=tabs]:h-8 data-[variant=tabs]:data-[size=sm]:h-7 data-[variant=tabs]:data-[size=lg]:h-9",
				className
			)}
			{...props}
		>
...
function ToggleGroupItem({
	...
	const isTabsVariant = resolvedVariant === "tabs"
